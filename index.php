...
require('regamisfunktsioon.php');

require('nav.php');

if(!empty($_REQUEST['eesnimi'])){
    lisaAndmed($_REQUEST['eesnimi'], $_REQUEST['perekonnanimi'], $_REQUEST['epost']);
...
<h1>Peoõhtu tantsusaalis!</h1>

<p>Veebruar 9 toimub suur peoõhtu nõmmel tantsusaalis. Palume täita registreerimisvorm kui soovite osaleda peol.</p>
<br>
<form action="?" method="post">
<h2>Registreerimisvorm</h2>
    <label>Eesnimi</label><br>
<input type="text" name="eesnimi" placeholder="Eesnimi"> <br> <br>

    <label>Perekonnanimi</label><br>
<input type="text" name="perekonnanimi" placeholder="Perekonnanimi"> <br> <br>
    <label>Elektronpost</label><br>

<input type="text" name="epost" placeholder="E-mail"> <br> <br>
